...
def parse_args():
    ...
    input_arguments.add_argument('-r', '--input_raw', type=str, default=None, required=True,
...
def main():
    ...
    logging.info("Preprocessing 1/2: Selecting subsets and feature engineering...")
    ...
    logging.info("Preprocessing 2/2: Quantizing targets...")
