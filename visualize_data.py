...
def parse_args():
    ...
    input_arguments.add_argument('-m', '--mode', type=str, default=None, required=True,
                                 help='analysis mode')
    # Output arguments
...
def main():
    ...
    if not os.path.exists(figures_output_dir) or args.overwrite:
        ...
        config.visualize_dataset(data, ActAreas, IC50s, dose_responses, mode=mode,outputdir=figures_output_dir)
