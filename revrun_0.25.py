...
config.save(to_save=final_data, name="REV_025_preprocessed_data")
...
config.save(to_save=trained_models, name="REV_025_pre-models")
...
config.save(to_save=final_results, name="REV_025_results")
config.save(to_save=feature_importances, name="REV_025_featimp")
config.save(to_save=base_models, name="REV_025_base-models")
