...
def permutation_importances(trained_model, predictors, target, folds=100, random_state=42):
...
def explain_model(model, predictors, target, folds=100, seed=42):
...
def explain_all(models, predictors, target, folds=100, seed=42):
