...
# config.save(to_save=final_data, name="f_test_topo_1")
...
selected_data_p1 = [x for x in load_failed_file.dataframe.index for y in cancer_types if y in x]
selected_data_p2 = [z for z in selected_data_p1 if z not in nan_samples]
not_selected_data = [x for x in load_failed_file.dataframe.index for y in cancer_types if y not in x]
